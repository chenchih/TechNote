...
Notice that the `test_greeting_1` and `test_gretting_2` **logic is the same**, just the passing name is different. If you have a lot of name to test, then you have to keep changing the name or implement many test case function. Instead of doing that you can **write multiply case**, we can use a **parameterized function**.
